...
(function() {
  ...
  angular
    .module('merchantApp')
    .controller('ApplicationDutiesListController', ApplicationDutiesListController);

  ApplicationDutiesListController.$inject = ['$compile', '$scope', '$stateParams', 'toaster', 'ApplicationService', 'DTOptionsBuilder', 'DTColumnBuilder', '$uibModal'];

  function ApplicationDutiesListController($compile, $scope, $stateParams, toaster, ApplicationService, DTOptionsBuilder, DTColumnBuilder, $uibModal) {
    var vm = this;
    ...
    function initDt() {
      ...
      vm.dtColumns = [
        ...
        DTColumnBuilder.newColumn('adminDuty.data.name').withTitle('申请人'),
    ...
    function dtAjax(data, callback, settings) {
      ...
      ApplicationService.adminDutyScores(params)
        .then(function(res) {
    ...
    function actionsHtml(data, type, full, meta) {
      ...
      return '<button class="btn btn-white btn-xs" uib-tooltip="查看信息" ui-sref="admin.application.dutiesEdit({id: ' + data.id + '})">' +
